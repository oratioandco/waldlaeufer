...
import { BEFEHL_VERBS, zauberePhrase, syllableRead, shieldWas, befehlOne, befehlTwo, befehlHelp, FIXED_GAMEPLAY, shopItemLine, SHOP_FIXED, FISHING_LINES, CAMP_SWAP } from '../src/learning/speech-lines.js';
