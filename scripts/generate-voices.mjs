...
import { BEFEHL_VERBS, zauberePhrase, syllableRead, shieldWas, befehlOne, befehlTwo, befehlHelp, FIXED_GAMEPLAY, shopItemLine, SHOP_FIXED, FISHING_LINES, CAMP_SWAP, CAMP_REST, RANK_UP, BOSS_HIT, ARCHERY_LINES, FIREFLY_LINES, HOPPER_LINES, TREASURE_INTRO, TREASURE_WIN, TREASURE_CLUES } from '../src/learning/speech-lines.js';
...
const VOICE_IDS = {
  ...
  boss:      'VvmLPzhPQHSqLOL9D1R7', // Gegner-/Schatten-Wächter-Stimme (vom Nutzer gewählt)
...
/* Schatten-Hieb (Boss) + Lagerfeuer-Erholung (Erzähler) */
add('boss', BOSS_HIT);
add('narrator', CAMP_REST);
